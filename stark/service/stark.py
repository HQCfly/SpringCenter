...
class ModelStark(object):
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                if pop_res_id:
                    ...
                    import json
                    return render(request, "stark_pop.html", {"res": res})
                else:
                    return redirect(self.get_list_url())

        return render(request, "stark_add.html", locals())
    ...
    def delete_view(self, request, id):
        ...
        return render(request, "stark_delete.html", locals())
    ...
    def change_view(self, request, id):
        ...
        return render(request, "stark_change.html", locals())
    ...
    def list_view(self, request):
        ...
        return render(request, "stark_list.html", locals())
